            ...
            return (
              ...
              >
                ...
                <motion.circle
                  ...
                  style={{ fill: isHovered ? d.color : undefined }}
          ...
          {PIE_DATA.map((item) => (
            ...
            >
              <div
                ...
                style={{ backgroundColor: item.color }}
              />
              <span className="text-sm font-bold uppercase text-black dark:text-white">
                {item.label}
              </span>
            </motion.div>
          ))}
...
export default function BentoDashboard() {
  return (
    <div className="min-h-screen w-full bg-zinc-100 dark:bg-transparent p-4 md:p-12 font-sans selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black flex flex-col transition-colors duration-200">
      {/* Texture Background */}
